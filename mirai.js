...
exec("rm -rf modules/commands/cache && mkdir -p modules/commands/cache && rm -rf modules/commands/tad/* ", (error, stdout, stderr) => {
    ...
    console.log(chalk.bold.hex("#00ffff")("DEVA ❯ ") + chalk.hex("#00ffff")("𝐟𝐢𝐱𝐞𝐝 𝐛𝐲 DEVA (DEVA 𝗚)"))
});
...
const login = require("team-atf-2");
...
console.log(chalk.bold.hex("#00ffff").bold("[ DEVA (XD) ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`𝐀𝐁𝐇𝐈`, '[ 𝐀𝐁𝐇𝐈 (𝐘𝐀𝐃𝐀𝐕) ]');
        logger('Hey, thank you for using this Bot', '[ 𝐀𝐁𝐇𝐈 (𝐘𝐀𝐃𝐀𝐕) ]');
        logger("𝐅𝐈𝐗𝐄𝐃 𝐁𝐘 𝐀𝐁𝐇𝐈", '[ 𝐀𝐁𝐇𝐈 (𝐘𝐀𝐃𝐀𝐕) ]');
